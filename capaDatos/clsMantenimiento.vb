...
Public Class clsMantenimiento
    ...
    Sub ejecutarTransaccion(list_trans As List(Of String))
        Try
            objConecta.abrirconexionTrans()
            cm.Connection = objConecta.miConexion
            cm.Transaction = objConecta.miTransaccion

            For Each strTrans As String In list_trans
                cm.CommandText = strTrans
                cm.ExecuteNonQuery()
            Next
